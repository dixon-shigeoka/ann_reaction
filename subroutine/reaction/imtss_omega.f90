subroutine imtss_omega(n,delt,dtmp,dprs,aYi,omegai,totaldens)
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
!
!
...
!$OMP PARALLEL
  ...
  !$OMP& PRIVATE (ar,au,av,awk1,awk2,awk3,adnsr,aprs,druo,atmw)               &
  !$OMP& PRIVATE (ahti,phti)     &
  ...
  do ii = 1, n
    ...
    totaldens(ii,1) = dprs(ii)*atmpr/druo

    adns(:) = aYi(:,ii)*totaldens(ii,1)
...
!    write(6,*) "before Loop totaldens", totaldens(ii,1)
!    write(6,*) "before Loop ii", ii
!    write(6,*) "before Loop tmp", atmp
!    write(6,*) "before Loop aeng", aYi(:,ii)
...
!    write(6,*) "after MTS", atime, ii, m, atmp
