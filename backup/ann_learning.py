...
train_y = train_y[:,np.array([0])] #H mass fraction
...
batch_size = 64
verbose = 1
#history = model.fit(train_x,train_y,batch_size,epochs,verbose,
#                    callbacks=cbks,validation_data=(test_x,test_y))
history = model.fit(train_x,train_y,batch_size,epochs,verbose,callbacks=cbks)
